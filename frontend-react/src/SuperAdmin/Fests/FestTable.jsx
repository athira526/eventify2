import {
  ...
  const FestTable = ({ isDashboard, name }) => {
        ...
        <Card className="mt-1">
          ...
          <TableContainer>
            <Table  aria-label="table in dashboard">
              ...
              <TableBody>
                {fest.fests.slice(0,isDashboard?7:fest.fests.length).map((item) => (
                  <TableRow
                    hover
                    key={item.name}
                    sx={{ "&:last-of-type td, &:last-of-type th": { bbooking: 0 } }}
                  >
                    <TableCell>
                      {" "}
