...
export const deleteMenuItemRequest = () => ({
  ...
  // Get Menu Items by Fest ID Actions
export const getMenuItemsByFestIdRequest = () => ({
    type: actionTypes.GET_MENU_ITEMS_BY_RESTAURANT_ID_REQUEST,
  });
  
  export const getMenuItemsByFestIdSuccess = (menuItems) => ({
    type: actionTypes.GET_MENU_ITEMS_BY_RESTAURANT_ID_SUCCESS,
    payload: menuItems,
  });
  
  export const getMenuItemsByFestIdFailure = (error) => ({
